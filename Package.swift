...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.0.0-beta+20230323132058.xcframework.zip",
			checksum: "1eb4b12da77adec855dea43fd3c2fc431003db4ecdf3e3efc61e19b3e7117bb3"
		)
	]
)