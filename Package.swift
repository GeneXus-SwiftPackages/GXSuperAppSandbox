...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "1.6.0-rc.0")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/preview/GXSuperAppSandbox-1.6.0-rc.0.xcframework.zip",
			checksum: "23c75baa011f3e8cf12eacacafd1ee67ca07a5611011f47532310d450a040fc3"
		)
	]
)