...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.0.0-beta+20230306135613.xcframework.zip",
			checksum: "b9e0e55deeae91dd296a6ce74b77fa658687357c30bbaf855a7da78ee5983ec6"
		)
	]
)