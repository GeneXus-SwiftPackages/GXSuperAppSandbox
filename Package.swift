...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.0.0-beta+20230315133647.xcframework.zip",
			checksum: "cadcd096ab6b5955bd27630cbfac7175c696b00d91514acc3fb0f32ad1fca85a"
		)
	]
)