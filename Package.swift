...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "1.1.2")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/releases/GXSuperAppSandbox-1.1.2.xcframework.zip",
			checksum: "45dbfa0bbb0887849d08e15a5b58c74131daf52e04045f359ca72182ab0d5a36"
		)
	]
)