...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "1.5.0-rc.2")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/preview/GXSuperAppSandbox-1.5.0-rc.2.xcframework.zip",
			checksum: "94c42f8729f16f596bccf86a1e15e058422c76611d4af548696cdc087a231042"
		)
	]
)