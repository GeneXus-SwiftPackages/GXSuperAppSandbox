...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "1.1.0-beta.6")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.1.0-beta.6.xcframework.zip",
			checksum: "32ed52b6b78a50ef05d57e0a3e84c54b5d0ec20b5d4acd0a2e1b72d5e6f4d9a6"
		)
	]
)