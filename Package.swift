...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.0.0-beta+20230307184249.xcframework.zip",
			checksum: "e34ef54381a17d1a666890e9e847cee637fa0ecdbf75f9eea70e50d7bb38b81e"
		)
	]
)