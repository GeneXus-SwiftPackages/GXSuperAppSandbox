...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "4.1.0-rc.25")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/preview/GXSuperAppSandbox-4.1.0-rc.25.xcframework.zip",
			checksum: "f5ca65abaff8ad699f1d8d0333cece182a532d57beb8cc30ae2bb8f27a68ab3b"
		)
	]
)