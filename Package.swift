...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.0.0-beta+20230316174639.xcframework.zip",
			checksum: "2cf39a8bab2f1600219a4c69658961a0056edb40004b997dee6a6243de9654a2"
		)
	]
)