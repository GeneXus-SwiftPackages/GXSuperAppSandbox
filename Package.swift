...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.0.0-beta+20230306150353.xcframework.zip",
			checksum: "3cbbe3e811b2e7837fdd422bf41f067cff68ddacfc22252ff91cc86745de11c1"
		)
	]
)