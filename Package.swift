...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "1.5.0-beta.26")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.5.0-beta.26.xcframework.zip",
			checksum: "6b239737edf1e99fd3c5ba7aa8cda415375a3673fceb619a13e58742938cb4f7"
		)
	]
)