...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.0.0-beta+20230519205149.xcframework.zip",
			checksum: "2a02cc79e62831919ddd2852dbbbd3bd21cbbdd4e6e50dbb0e264cd57b60743e"
		)
	]
)