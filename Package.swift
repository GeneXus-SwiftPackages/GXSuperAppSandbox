...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "3.0.0-beta.16")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-3.0.0-beta.16.xcframework.zip",
			checksum: "eb26ee40cce83d3806fd1a420ebf3aecf1d2f4438ec0a22deff529abe71583ee"
		)
	]
)