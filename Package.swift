...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "1.3.0-rc.13")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/preview/GXSuperAppSandbox-1.3.0-rc.13.xcframework.zip",
			checksum: "062d7cafb225e4a68a26463dfe2ef59b75237ccb1a080d6a68efa73c989d64bb"
		)
	]
)