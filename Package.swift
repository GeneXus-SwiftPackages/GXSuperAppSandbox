...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "1.1.3")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/releases/GXSuperAppSandbox-1.1.3.xcframework.zip",
			checksum: "37a8f8c51857ee2b0776f5f0b1a27d0e293e1d69d6b4d7864095a5c725a6e14e"
		)
	]
)