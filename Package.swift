...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.0.0-beta+20230405133406.xcframework.zip",
			checksum: "e26346d7d4a5f92e03bcfa5326ec777004dd81ff794c369ead77e8eb30e75373"
		)
	]
)