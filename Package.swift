...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXSuperApp.git", exact: "3.0.0-rc.15")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/preview/GXSuperAppSandbox-3.0.0-rc.15.xcframework.zip",
			checksum: "592e91eaadec48ce7ddb86ba21fcca1978b4eb1633a383e1bbe08d50cf7ea218"
		)
	]
)