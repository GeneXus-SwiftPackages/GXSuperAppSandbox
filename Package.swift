...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXSuperAppSandbox",
			url: "https://pkgs.genexus.dev/iOS/beta/GXSuperAppSandbox-1.0.0-beta+20230220183523.xcframework.zip",
			checksum: "c095c1865313b87304e4ebde7b2b8618f6056b6c0ed05ce3211be06d96fc1e72"
		)
	]
)